...
#if defined(NDEBUG)
# error "BitsCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "BitsCoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("bitscoin-scriptch");
