...
static void SetupBitsCoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitscoin-tx [options] <hex-tx> [commands]  Update hex-encoded bitscoin transaction\n" +
            "or:     bitscoin-tx [options] -create [commands]   Create hex-encoded bitscoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitscoin transaction
