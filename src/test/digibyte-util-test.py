...
# Copyright 2016 The BitsCoin Core developers
...
help_text="""Test framework for bitscoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/bitscoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "bitscoin-util-test.json", buildenv)
