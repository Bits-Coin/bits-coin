    ...
    mapper(0)
{
    ...
    ui->bitscoinAtStartup->setToolTip(ui->bitscoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitscoinAtStartup->setText(ui->bitscoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitsCoinConfButton->setToolTip(ui->openBitsCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitsCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitsCoinConfButton_clicked()
{
