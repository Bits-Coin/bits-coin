...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, BitsCoinUnits::SeparatorStyle separators=BitsCoinUnits::separatorStandard) const;
