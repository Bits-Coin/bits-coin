...
/** BitsCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitsCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitsCoinUnits(QObject *parent);

    /** BitsCoin units.
      @note Source: https://en.bitscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DGB,
...
typedef BitsCoinUnits::Unit BitsCoinUnit;
