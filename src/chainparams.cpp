...
{
    const char* pszTimestamp = "The evolution of technology opens doors to a new decentralized financial freedom era";
...
public:
    CMainParams() {
        ...
        /** Current BitsCoin 2017 Difficulty Adjustment Code & Block Target. See explanation here: 
        https://github.com/bitscoin/bitscoin-old/pull/36 
        https://github.com/bitscoin/bitscoin-old/pull/15
        ...
        **/
        ...
        consensus.patchBlockRewardDuration2 = 0; //80160;
        ...
        // BitsCoin Hard Fork Block Heights
        consensus.multiAlgoDiffChangeTarget = 0; // Block 145,000 MultiAlgo Hard Fork
        consensus.alwaysUpdateDiffChangeTarget = 0; // Block 400,000 MultiShield Hard Fork
        consensus.workComputationChangeTarget = 0; // Block 1,430,000 DigiSpeed Hard Fork
        consensus.algoSwapChangeTarget = 0; // Block 9,100,000 Odo PoW Hard Fork
      ...
      //  consensus.nMinimumChainWork = uint256S("0x00");
        ...
        consensus.defaultAssumeValid = uint256S("0xad5f896d8f51808caacf21f46f6456ff4d29e2c58b40744b93f913a8bdc5702a"); // Block 6,000,000
		...
		genesis = CreateGenesisBlock(1634256001, 2670942 , 0x1e0ffff0, 1, 1000 * COIN);
		
        consensus.hashGenesisBlock = genesis.GetHash();
	    assert(consensus.hashGenesisBlock == uint256S("0x876a286dfad4ec1afc5a0fa9a38c4eacd76278461c45a5d3722bd26bd1e3f356"));
        assert(genesis.hashMerkleRoot == uint256S("0x1511db04059d32e8c34c2b1e0091395e115edaac84f39cffd1ceb0f9eedf3cb4"));

        // Note that of those with the service bits flag, most only support a subset of possible options
		  // vSeeds.emplace_back("155.138.130.28");
        vSeeds.emplace_back("dnsseed.bits-coin.io");
		vSeeds.emplace_back("dnsseed1.bits-coin.io");
		vSeeds.emplace_back("dnsseed2.bits-coin.io");
		vSeeds.emplace_back("dnsseed3.bits-coin.io"); 
        //vSeeds.emplace_back("seed2.bitscoin.io");
       // vSeeds.emplace_back("seed3.bitscoin.io");
       // vSeeds.emplace_back("seed.bitscoin.io");
        //vSeeds.emplace_back("digihash.co");
       // vSeeds.emplace_back("digiexplorer.info");
      //  vSeeds.emplace_back("seed.bitscoinprojects.com");
        ...
        checkpointData = (CCheckpointData) {
         {
            {     0, uint256S("0x876a286dfad4ec1afc5a0fa9a38c4eacd76278461c45a5d3722bd26bd1e3f356")},
        ...
        chainTxData = ChainTxData{
            ...
            1634256001, // * UNIX timestamp of last known number of transactions
...
*/
        ...
        genesis = CreateGenesisBlock(1634256001, 1068295 , 0x1e0ffff0, 1, 1000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x69063046711e7ba98e39f53489f96435e6cb01bb97e0bc6d9fe360e68a225b38"));
        assert(genesis.hashMerkleRoot == uint256S("0x1511db04059d32e8c34c2b1e0091395e115edaac84f39cffd1ceb0f9eedf3cb4"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
       // vSeeds.emplace_back("seed1.bitscoin.io");
        //vSeeds.emplace_back("seed2.bitscoin.io");
        //vSeeds.emplace_back("seed3.bitscoin.io");
        //vSeeds.emplace_back("testnet-seed.bitscoinprojects.com");
        //vSeeds.emplace_back("testnet-1.us.bitscoinservers.io");
        ...
        checkpointData = {
            {
                {     0, uint256S("0x69063046711e7ba98e39f53489f96435e6cb01bb97e0bc6d9fe360e68a225b38")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1634256001, 0, 0x207fffff, 1, 1000 * COIN);      
        consensus.hashGenesisBlock = genesis.GetHash();
