...
unlocked to sign the BitsCoin-Qt.app bundle.
...
allowing somebody to distribute a BitsCoin-Qt.app or bitscoin-qt-setup.exe with a valid
...
that the bitscoin-qt.exe file inside the installer had not been tampered with.
