...
"""Verify that starting bitscoin with -h works as expected."""

from test_framework.test_framework import BitsCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BitsCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitscoin with -h for help text")
        ...
        self.log.info("Start bitscoin with -version for version information")
        ...
        self.log.info("Start bitscoind with -fakearg to make sure it does not start")
