...
class BIP66Test(BitsCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitscoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitscoind produces more specific reject
            # reasons.
