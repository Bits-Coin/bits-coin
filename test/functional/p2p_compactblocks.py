...
# TestP2PConn: A peer we use to send messages to bitscoind, and store responses.
...
class CompactBlocksTest(BitsCoinTestFramework):
    ...
    # This test actually causes bitscoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitscoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitscoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitscoind will not send blocktxn responses for blocks whose height is
