#!/usr/bin/env python3
# Copyright (c) 2015-2017 The BitsCoin Core developers
...
from test_framework.test_framework import BitsCoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (BitsCoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitscoin has been built with ZMQ enabled
