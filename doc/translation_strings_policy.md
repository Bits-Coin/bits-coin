...
This document provides guidelines for internationalization of the BitsCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitscoin_en.ts` remains unchanged.
