...
* bitscoin.conf: contains configuration settings for bitscoind or bitscoin-qt
* bitscoind.pid: stores the process id of bitscoind while running
...
* debug.log: contains debug information and general logging generated by bitscoind or bitscoin-qt
