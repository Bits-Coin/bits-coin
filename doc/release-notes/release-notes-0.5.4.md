BitsCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitscoin/files/BitsCoin/bitscoin-0.5.4/
...
http://gitorious.org/bitscoin/bitscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitsCoin-Qt notifications under Growl 1.3.
Increase required age of BitsCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitsCoin properly when installing BitsCoin-Qt over it. (Windows)
