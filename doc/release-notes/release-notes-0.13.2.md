BitsCoin Core version 0.13.2 is now available from:

  <https://bitscoin.org/bin/bitscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bitscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitscoin-tx to create v2 transactions (dgbdrak)
