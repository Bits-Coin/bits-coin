BitsCoin Core version 0.16.1 is now available from:

  <https://bitscoincore.org/bin/bitscoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitscoind processes are cleaned up when tests end (sdaftuar)
