BitsCoin Core version 0.9.4 is now available from:

  https://bitscoin.org/bin/0.9.4/
...
this update is incompatible with the BitsCoin system and could lead to consensus
forks.

BitsCoin Core released binaries from https://bitscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitscoin/+archive/ubuntu/bitscoin
- A third-party or self-compiled BitsCoin Core

upgrade to BitsCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
