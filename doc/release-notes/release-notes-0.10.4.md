BitsCoin Core version 0.10.4 is now available from:

  <https://bitscoin.org/bin/bitscoin-core-0.10.4/>
...
- #6953 `43c2789` Split bitscoin-tx into its own package
- #6953 `dfe0d4d` Include bitscoin-tx binary on Debian/Ubuntu
