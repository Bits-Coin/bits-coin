BitsCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitscoin/files/BitsCoin/bitscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitsCoin
...
New/changed settings (command-line or bitscoin.conf file)
--------------------------------------------------------
